...
module SigningTodayAPIClient
  ...
  class Identity
    ...
    attr_accessor :has_been_imported
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'provider_image')
        self.provider_image = attributes[:'provider_image']
      end

      if attributes.key?(:'send_otp_url')
        self.send_otp_url = attributes[:'send_otp_url']
      end

      if attributes.key?(:'sign_url')
        self.sign_url = attributes[:'sign_url']
      end

      if attributes.key?(:'has_been_imported')
        self.has_been_imported = attributes[:'has_been_imported']
      end
    end
    ...
    def valid?
      status_validator = EnumAttributeValidator.new('String', ["pending", "active", "error"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["pending", "active", "error"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          provider_image == o.provider_image &&
          send_otp_url == o.send_otp_url &&
          sign_url == o.sign_url &&
          has_been_imported == o.has_been_imported
    end
    ...
    def hash
      [id, certificate, not_after, status, _next, actions, provider, label, signature_appearance_uri, provider_id, provider_type, provider_data, provider_image, send_otp_url, sign_url, has_been_imported].hash
    end
