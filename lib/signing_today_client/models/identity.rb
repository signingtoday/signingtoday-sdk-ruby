...
module SigningTodayAPIClient
  ...
  class Identity
    ...
    def hash
      [actions, certificate, has_been_imported, id, label, _next, not_after, provider, provider_data, provider_id, provider_image, provider_type, send_otp_url, sign_url, signature_appearance_uri, status].hash
    end
