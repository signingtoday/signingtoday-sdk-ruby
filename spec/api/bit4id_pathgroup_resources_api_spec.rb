...
# Unit tests for SigningTodayAPIClient::Bit4idPathgroupResourcesApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Bit4idPathgroupResourcesApi' do
  before do
  ...
  describe 'test an instance of Bit4idPathgroupResourcesApi' do
    it 'should create an instance of Bit4idPathgroupResourcesApi' do
      expect(@api_instance).to be_instance_of(SigningTodayAPIClient::Bit4idPathgroupResourcesApi)
    end
  end
