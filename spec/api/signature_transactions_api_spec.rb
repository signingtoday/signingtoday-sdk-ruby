...
# Unit tests for SigningTodayAPIClient::SignatureTransactionsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SignatureTransactionsApi' do
  before do
  ...
  describe 'test an instance of SignatureTransactionsApi' do
    it 'should create an instance of SignatureTransactionsApi' do
      expect(@api_instance).to be_instance_of(SigningTodayAPIClient::SignatureTransactionsApi)
    end
  end
