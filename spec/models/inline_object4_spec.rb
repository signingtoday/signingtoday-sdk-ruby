...
# Unit tests for SigningTodayAPIClient::InlineObject4
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InlineObject4' do
  before do
    # run before each test
    @instance = SigningTodayAPIClient::InlineObject4.new
  end
  ...
  describe 'test an instance of InlineObject4' do
    it 'should create an instance of InlineObject4' do
      expect(@instance).to be_instance_of(SigningTodayAPIClient::InlineObject4)
    end
  end
