...
# Unit tests for SigningTodayAPIClient::Bit4idPathgroupTokensApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Bit4idPathgroupTokensApi' do
  before do
  ...
  describe 'test an instance of Bit4idPathgroupTokensApi' do
    it 'should create an instance of Bit4idPathgroupTokensApi' do
      expect(@api_instance).to be_instance_of(SigningTodayAPIClient::Bit4idPathgroupTokensApi)
    end
  end
  ...
  # @param organization_id The **organization-id** represents an organization that is included in the SigninToday application, also know as **slug** and it is used as a path parameter to restrict the asked functionality to the specified organization 
  # @param token_id The **token-id** is the uuid code that identifies a token. It is, as well, used to restrict the requested operation to the scope of that token 
  # @param [Hash] opts the optional parameters
  ...
  # unit tests for list_user_tokens
  ...
  # @option opts [String] :where_order The **where_order** query parameter takes one or more values separated by a comma and a space. The result will be ordered by the first value (ascending order is implied; a \&quot;**-**\&quot; in front of the value indicates descending order), then the second value and so on
  # @return [InlineResponse2004]
  describe 'list_user_tokens test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
