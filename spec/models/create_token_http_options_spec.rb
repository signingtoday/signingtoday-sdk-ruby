...
# Unit tests for SigningTodayAPIClient::CreateTokenHttpOptions
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CreateTokenHttpOptions' do
  before do
    # run before each test
    @instance = SigningTodayAPIClient::CreateTokenHttpOptions.new
  end
  ...
  describe 'test an instance of CreateTokenHttpOptions' do
    it 'should create an instance of CreateTokenHttpOptions' do
      expect(@instance).to be_instance_of(SigningTodayAPIClient::CreateTokenHttpOptions)
    end
  end
