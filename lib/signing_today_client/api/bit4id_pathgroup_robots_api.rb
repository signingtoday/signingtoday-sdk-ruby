  ...
  class Bit4idPathgroupRobotsApi
    ...
    def robot_authentication_delete_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Bit4idPathgroupRobotsApi.robot_authentication_delete ...'
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: Bit4idPathgroupRobotsApi#robot_authentication_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def robot_authentication_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Bit4idPathgroupRobotsApi.robot_authentication_get ...'
      end
      # resource path
      local_var_path = '/robot/authentication'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: Bit4idPathgroupRobotsApi#robot_authentication_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def robot_configuration_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Bit4idPathgroupRobotsApi.robot_configuration_get ...'
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: Bit4idPathgroupRobotsApi#robot_configuration_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def robot_configuration_put_with_http_info(robot_configuration, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Bit4idPathgroupRobotsApi.robot_configuration_put ...'
      end
      ...
      if @api_client.config.client_side_validation && robot_configuration.nil?
        fail ArgumentError, "Missing the required parameter 'robot_configuration' when calling Bit4idPathgroupRobotsApi.robot_configuration_put"
      end
      # resource path
      local_var_path = '/robot/configuration'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: Bit4idPathgroupRobotsApi#robot_configuration_put\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def robot_ds_ts_post_with_http_info(create_digital_signature_transaction, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Bit4idPathgroupRobotsApi.robot_ds_ts_post ...'
      end
      ...
      if @api_client.config.client_side_validation && create_digital_signature_transaction.nil?
        fail ArgumentError, "Missing the required parameter 'create_digital_signature_transaction' when calling Bit4idPathgroupRobotsApi.robot_ds_ts_post"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: Bit4idPathgroupRobotsApi#robot_ds_ts_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def robot_id_instantiate_post_with_http_info(id, instantiate_dst_template, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Bit4idPathgroupRobotsApi.robot_id_instantiate_post ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling Bit4idPathgroupRobotsApi.robot_id_instantiate_post"
      end
      ...
      if @api_client.config.client_side_validation && instantiate_dst_template.nil?
        fail ArgumentError, "Missing the required parameter 'instantiate_dst_template' when calling Bit4idPathgroupRobotsApi.robot_id_instantiate_post"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: Bit4idPathgroupRobotsApi#robot_id_instantiate_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
