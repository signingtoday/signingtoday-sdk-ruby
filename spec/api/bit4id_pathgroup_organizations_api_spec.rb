...
# Unit tests for SigningTodayAPIClient::Bit4idPathgroupOrganizationsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Bit4idPathgroupOrganizationsApi' do
  before do
  ...
  describe 'test an instance of Bit4idPathgroupOrganizationsApi' do
    it 'should create an instance of Bit4idPathgroupOrganizationsApi' do
      expect(@api_instance).to be_instance_of(SigningTodayAPIClient::Bit4idPathgroupOrganizationsApi)
    end
  end
  ...
  # unit tests for patch_organization
  ...
  # @param organization_id The **organization-id** represents an organization that is included in the SigninToday application, also know as **slug** and it is used as a path parameter to restrict the asked functionality to the specified organization 
  # @param update_organization The settings of the organization to edit
  # @param [Hash] opts the optional parameters
  # @return [InlineResponse200]
  describe 'patch_organization test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
