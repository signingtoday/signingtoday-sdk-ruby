  ...
  class Bit4idPathgroupDigitalSignatureTransactionsApi
    ...
    def d_s_ts_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Bit4idPathgroupDigitalSignatureTransactionsApi.d_s_ts_get ...'
      end
      # resource path
      local_var_path = '/DSTs'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: Bit4idPathgroupDigitalSignatureTransactionsApi#d_s_ts_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def d_s_ts_post_with_http_info(digital_signature_transaction, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Bit4idPathgroupDigitalSignatureTransactionsApi.d_s_ts_post ...'
      end
      ...
      if @api_client.config.client_side_validation && digital_signature_transaction.nil?
        fail ArgumentError, "Missing the required parameter 'digital_signature_transaction' when calling Bit4idPathgroupDigitalSignatureTransactionsApi.d_s_ts_post"
      end
      # resource path
      local_var_path = '/DSTs'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: Bit4idPathgroupDigitalSignatureTransactionsApi#d_s_ts_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def d_st_id_audit_get_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Bit4idPathgroupDigitalSignatureTransactionsApi.d_st_id_audit_get ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling Bit4idPathgroupDigitalSignatureTransactionsApi.d_st_id_audit_get"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: Bit4idPathgroupDigitalSignatureTransactionsApi#d_st_id_audit_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def d_st_id_delete_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Bit4idPathgroupDigitalSignatureTransactionsApi.d_st_id_delete ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling Bit4idPathgroupDigitalSignatureTransactionsApi.d_st_id_delete"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: Bit4idPathgroupDigitalSignatureTransactionsApi#d_st_id_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def d_st_id_fill_patch_with_http_info(id, fillable_form, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Bit4idPathgroupDigitalSignatureTransactionsApi.d_st_id_fill_patch ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling Bit4idPathgroupDigitalSignatureTransactionsApi.d_st_id_fill_patch"
      end
      # verify the required parameter 'fillable_form' is set
      if @api_client.config.client_side_validation && fillable_form.nil?
        fail ArgumentError, "Missing the required parameter 'fillable_form' when calling Bit4idPathgroupDigitalSignatureTransactionsApi.d_st_id_fill_patch"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: Bit4idPathgroupDigitalSignatureTransactionsApi#d_st_id_fill_patch\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def d_st_id_get_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Bit4idPathgroupDigitalSignatureTransactionsApi.d_st_id_get ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling Bit4idPathgroupDigitalSignatureTransactionsApi.d_st_id_get"
      end
      # resource path
      local_var_path = '/DST/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: Bit4idPathgroupDigitalSignatureTransactionsApi#d_st_id_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def d_st_id_instantiate_post_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Bit4idPathgroupDigitalSignatureTransactionsApi.d_st_id_instantiate_post ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling Bit4idPathgroupDigitalSignatureTransactionsApi.d_st_id_instantiate_post"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: Bit4idPathgroupDigitalSignatureTransactionsApi#d_st_id_instantiate_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def d_st_id_modify_post_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Bit4idPathgroupDigitalSignatureTransactionsApi.d_st_id_modify_post ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling Bit4idPathgroupDigitalSignatureTransactionsApi.d_st_id_modify_post"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: Bit4idPathgroupDigitalSignatureTransactionsApi#d_st_id_modify_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def d_st_id_notify_post_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Bit4idPathgroupDigitalSignatureTransactionsApi.d_st_id_notify_post ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling Bit4idPathgroupDigitalSignatureTransactionsApi.d_st_id_notify_post"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: Bit4idPathgroupDigitalSignatureTransactionsApi#d_st_id_notify_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def d_st_id_publish_post_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Bit4idPathgroupDigitalSignatureTransactionsApi.d_st_id_publish_post ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling Bit4idPathgroupDigitalSignatureTransactionsApi.d_st_id_publish_post"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: Bit4idPathgroupDigitalSignatureTransactionsApi#d_st_id_publish_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def d_st_id_put_with_http_info(id, digital_signature_transaction, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Bit4idPathgroupDigitalSignatureTransactionsApi.d_st_id_put ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling Bit4idPathgroupDigitalSignatureTransactionsApi.d_st_id_put"
      end
      # verify the required parameter 'digital_signature_transaction' is set
      if @api_client.config.client_side_validation && digital_signature_transaction.nil?
        fail ArgumentError, "Missing the required parameter 'digital_signature_transaction' when calling Bit4idPathgroupDigitalSignatureTransactionsApi.d_st_id_put"
      end
      # resource path
      local_var_path = '/DST/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: Bit4idPathgroupDigitalSignatureTransactionsApi#d_st_id_put\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def d_st_id_replace_post_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Bit4idPathgroupDigitalSignatureTransactionsApi.d_st_id_replace_post ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling Bit4idPathgroupDigitalSignatureTransactionsApi.d_st_id_replace_post"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: Bit4idPathgroupDigitalSignatureTransactionsApi#d_st_id_replace_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def d_st_id_sign_doc_id_sign_id_get_with_http_info(id, doc_id, sign_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Bit4idPathgroupDigitalSignatureTransactionsApi.d_st_id_sign_doc_id_sign_id_get ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling Bit4idPathgroupDigitalSignatureTransactionsApi.d_st_id_sign_doc_id_sign_id_get"
      end
      # verify the required parameter 'doc_id' is set
      if @api_client.config.client_side_validation && doc_id.nil?
        fail ArgumentError, "Missing the required parameter 'doc_id' when calling Bit4idPathgroupDigitalSignatureTransactionsApi.d_st_id_sign_doc_id_sign_id_get"
      end
      # verify the required parameter 'sign_id' is set
      if @api_client.config.client_side_validation && sign_id.nil?
        fail ArgumentError, "Missing the required parameter 'sign_id' when calling Bit4idPathgroupDigitalSignatureTransactionsApi.d_st_id_sign_doc_id_sign_id_get"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: Bit4idPathgroupDigitalSignatureTransactionsApi#d_st_id_sign_doc_id_sign_id_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def d_st_id_templatize_post_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Bit4idPathgroupDigitalSignatureTransactionsApi.d_st_id_templatize_post ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling Bit4idPathgroupDigitalSignatureTransactionsApi.d_st_id_templatize_post"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: Bit4idPathgroupDigitalSignatureTransactionsApi#d_st_id_templatize_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
