...
module SigningTodayAPIClient
  class UpdateOrganization
    ...
    attr_accessor :dst_default_days
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'dst_default_days')
        self.dst_default_days = attributes[:'dst_default_days']
      else
        self.dst_default_days = 3
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          dst_default_days == o.dst_default_days &&
    ...
    def hash
      [default_rao, dst_default_days, signature_appearance, name, logo].hash
    end
