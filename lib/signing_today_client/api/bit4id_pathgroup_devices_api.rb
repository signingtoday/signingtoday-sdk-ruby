  ...
  class Bit4idPathgroupDevicesApi
    ...
    def device_authorization_delete_with_http_info(device_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Bit4idPathgroupDevicesApi.device_authorization_delete ...'
      end
      # verify the required parameter 'device_id' is set
      if @api_client.config.client_side_validation && device_id.nil?
        fail ArgumentError, "Missing the required parameter 'device_id' when calling Bit4idPathgroupDevicesApi.device_authorization_delete"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: Bit4idPathgroupDevicesApi#device_authorization_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def device_authorization_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Bit4idPathgroupDevicesApi.device_authorization_get ...'
      end
      # resource path
      local_var_path = '/device/authorization'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: Bit4idPathgroupDevicesApi#device_authorization_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def device_authorization_post_with_http_info(inline_object7, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Bit4idPathgroupDevicesApi.device_authorization_post ...'
      end
      # verify the required parameter 'inline_object7' is set
      if @api_client.config.client_side_validation && inline_object7.nil?
        fail ArgumentError, "Missing the required parameter 'inline_object7' when calling Bit4idPathgroupDevicesApi.device_authorization_post"
      end
      # resource path
      local_var_path = '/device/authorization'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: Bit4idPathgroupDevicesApi#device_authorization_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def devices_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Bit4idPathgroupDevicesApi.devices_get ...'
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: Bit4idPathgroupDevicesApi#devices_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
