...
# Unit tests for SigningTodayAPIClient::DigitalSignatureTransactionsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'DigitalSignatureTransactionsApi' do
  before do
  ...
  describe 'test an instance of DigitalSignatureTransactionsApi' do
    it 'should create an instance of DigitalSignatureTransactionsApi' do
      expect(@api_instance).to be_instance_of(SigningTodayAPIClient::DigitalSignatureTransactionsApi)
    end
  end
