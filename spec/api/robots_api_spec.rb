...
# Unit tests for SigningTodayAPIClient::RobotsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'RobotsApi' do
  before do
  ...
  describe 'test an instance of RobotsApi' do
    it 'should create an instance of RobotsApi' do
      expect(@api_instance).to be_instance_of(SigningTodayAPIClient::RobotsApi)
    end
  end
