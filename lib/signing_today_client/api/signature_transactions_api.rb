  ...
  class SignatureTransactionsApi
    ...
    def cancel_dst_with_http_info(organization_id, dst_id, inline_object2, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SignatureTransactionsApi.cancel_dst ...'
      end
      # verify the required parameter 'organization_id' is set
      if @api_client.config.client_side_validation && organization_id.nil?
        fail ArgumentError, "Missing the required parameter 'organization_id' when calling SignatureTransactionsApi.cancel_dst"
      end
      # verify the required parameter 'dst_id' is set
      if @api_client.config.client_side_validation && dst_id.nil?
        fail ArgumentError, "Missing the required parameter 'dst_id' when calling SignatureTransactionsApi.cancel_dst"
      end
      # verify the required parameter 'inline_object2' is set
      if @api_client.config.client_side_validation && inline_object2.nil?
        fail ArgumentError, "Missing the required parameter 'inline_object2' when calling SignatureTransactionsApi.cancel_dst"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SignatureTransactionsApi#cancel_dst\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def create_dst_with_http_info(organization_id, create_signature_transaction, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SignatureTransactionsApi.create_dst ...'
      end
      # verify the required parameter 'organization_id' is set
      if @api_client.config.client_side_validation && organization_id.nil?
        fail ArgumentError, "Missing the required parameter 'organization_id' when calling SignatureTransactionsApi.create_dst"
      end
      ...
      if @api_client.config.client_side_validation && create_signature_transaction.nil?
        fail ArgumentError, "Missing the required parameter 'create_signature_transaction' when calling SignatureTransactionsApi.create_dst"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SignatureTransactionsApi#create_dst\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def delete_dst_resources_with_http_info(organization_id, dst_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SignatureTransactionsApi.delete_dst_resources ...'
      end
      # verify the required parameter 'organization_id' is set
      if @api_client.config.client_side_validation && organization_id.nil?
        fail ArgumentError, "Missing the required parameter 'organization_id' when calling SignatureTransactionsApi.delete_dst_resources"
      end
      # verify the required parameter 'dst_id' is set
      if @api_client.config.client_side_validation && dst_id.nil?
        fail ArgumentError, "Missing the required parameter 'dst_id' when calling SignatureTransactionsApi.delete_dst_resources"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SignatureTransactionsApi#delete_dst_resources\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_document_with_http_info(organization_id, document_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SignatureTransactionsApi.get_document ...'
      end
      # verify the required parameter 'organization_id' is set
      if @api_client.config.client_side_validation && organization_id.nil?
        fail ArgumentError, "Missing the required parameter 'organization_id' when calling SignatureTransactionsApi.get_document"
      end
      # verify the required parameter 'document_id' is set
      if @api_client.config.client_side_validation && document_id.nil?
        fail ArgumentError, "Missing the required parameter 'document_id' when calling SignatureTransactionsApi.get_document"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SignatureTransactionsApi#get_document\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
