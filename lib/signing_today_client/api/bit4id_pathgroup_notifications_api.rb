  ...
  class Bit4idPathgroupNotificationsApi
    ...
    def notifications_dst_id_delete_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Bit4idPathgroupNotificationsApi.notifications_dst_id_delete ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling Bit4idPathgroupNotificationsApi.notifications_dst_id_delete"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: Bit4idPathgroupNotificationsApi#notifications_dst_id_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def notifications_dsts_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Bit4idPathgroupNotificationsApi.notifications_dsts_get ...'
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: Bit4idPathgroupNotificationsApi#notifications_dsts_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def notifications_push_token_delete_with_http_info(device_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Bit4idPathgroupNotificationsApi.notifications_push_token_delete ...'
      end
      # verify the required parameter 'device_id' is set
      if @api_client.config.client_side_validation && device_id.nil?
        fail ArgumentError, "Missing the required parameter 'device_id' when calling Bit4idPathgroupNotificationsApi.notifications_push_token_delete"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: Bit4idPathgroupNotificationsApi#notifications_push_token_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def notifications_push_token_post_with_http_info(inline_object6, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: Bit4idPathgroupNotificationsApi.notifications_push_token_post ...'
      end
      # verify the required parameter 'inline_object6' is set
      if @api_client.config.client_side_validation && inline_object6.nil?
        fail ArgumentError, "Missing the required parameter 'inline_object6' when calling Bit4idPathgroupNotificationsApi.notifications_push_token_post"
      end
      # resource path
      local_var_path = '/notifications/push-token'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: Bit4idPathgroupNotificationsApi#notifications_push_token_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
