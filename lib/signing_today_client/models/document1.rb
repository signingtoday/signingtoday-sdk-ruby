...
module SigningTodayAPIClient
  class Document1
    ...
    attr_accessor :document_uri_options
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SigningTodayAPIClient::Document1` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SigningTodayAPIClient::Document1`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'document_uri_options')
        self.document_uri_options = attributes[:'document_uri_options']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          document_uri_options == o.document_uri_options &&
          groups == o.groups &&
          preview == o.preview
    end
    ...
    def hash
      [display_name, document, document_uri, document_uri_options, groups, preview].hash
    end
