...
# Unit tests for SigningTodayAPIClient::Bit4idPathgroupDevicesApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Bit4idPathgroupDevicesApi' do
  before do
  ...
  describe 'test an instance of Bit4idPathgroupDevicesApi' do
    it 'should create an instance of Bit4idPathgroupDevicesApi' do
      expect(@api_instance).to be_instance_of(SigningTodayAPIClient::Bit4idPathgroupDevicesApi)
    end
  end
